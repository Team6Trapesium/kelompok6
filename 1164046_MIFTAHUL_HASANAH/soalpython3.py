...
w.shapeType=3 	 					#mengecek writer diset tipe nya sebagai point apa, line atau polygon, kalo () kosong berarti tidak diset
w.shapeType 						#mengecek writer diset tipe nya sebagai point apa, line atau polygon, kalo () kosong berarti tidak diset
...
w.save("soal3") 					#untuk melakukan simpan dengan nama soal3