...
w.poly(parts=[[[1,3],[5,3],[1,2],[5,2],[1,3]]],shapeType=shapefile.POLYLINE)	#digunakan untuk menghubungkan titik titik ,sehingga akan menjadi sebuah garis, yang mana garis garis tersebut terhubungsatu sama lainnya.
