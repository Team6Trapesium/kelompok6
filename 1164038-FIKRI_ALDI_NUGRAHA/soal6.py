...
w.poly(parts=[[[1,3],[5,3]]], shapeType=shapefile.POLYLINE)     #mengisi file shp dengan garis, tetapi garis nya sudah ditentukan pada koordinat tertentu 
                                                                #serta shape type di set sebagai polyline

w.save("soal6")                                                 #untuk melakukan save file shp dengan nama soal6