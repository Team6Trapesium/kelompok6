...
w=shapefile.Writer(shapeType=1)     #Membuat shpfile baru

w.shapeType=2                         #Mengecek point, line atau polygon, jika () berarti tidak 
w.shapeType=3                        #Mengecek point, line atau polygon, jika () berarti tidak
w.shapeType=4                         #Mengecek point, line atau polygon, jika () berarti tidak
...
w.save("soal3")                     #Melakukan save dengan nama soal3